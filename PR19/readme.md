...
> Из массива удалить нечетные элементы, стоящие между минимальным и максимальным элементами.

#### Системный анализ:

> Входные данные: `array arr`  
> Промежуточные данные: `int min_index` `int max_index`  
